...
export class TasksController {
    ...
    async create(
        ...
        const userId = req['userId'];
        try {
            const task = await this.tasksService.createTask(userId, dto.title, dto.description, dto.columnId, dto.image);
    ...
    async update(
        ...
        const userId = req['userId'];
        try {
            const updated = await this.tasksService.updateTask(id, userId, dto.title, dto.description, dto.columnId, dto.image);
